...
loadConfig('cnblogs', {".line_bc":{"widget":"line","title":"❗❗❗修改完记得点保存(在最下面)❗❗❗"},".line_sw":{"widget":"line","title":"❗开关还没做完❗"},"logo_switch":{"title":"LOGO替换","default":true,"widget":"switch","type":"boolean"},"menu_switch":{"title":"首页左侧菜单增强","default":true,"widget":"switch","type":"boolean"},"auto_pager_ing_switch":{"title":"闪存自动翻页开关","default":true,"widget":"switch","type":"boolean"}})

let features_cnblogs_1574814730 = {
...
run(features_cnblogs_1574814730);
} catch (e) {
...
run(features_config_test_545080235);
    ...
    console.error(`config_test: ${e.message}`);
    console.error(e);
}
