...
key: "ad", 
	// 广告屏蔽
	showInMenu: true,
	value: `@charset "UTF-8";.bili-video-card:has(svg.bili-video-card__info--ad),.feed-card:has(svg.bili-video-card__info--ad){display:none}#bannerAd,#slide_ad{display:none}`,
});
...
key: "header", 
	value: {
		...
		blur: `:root body #app .bili-header .bili-header__bar.mini-header,:root body #i_cecream .bili-feed4 .bili-header .bili-header__bar.mini-header,html body #app .bili-header .bili-header__bar.mini-header,html body #i_cecream .bili-feed4 .bili-header .bili-header__bar.mini-header{backdrop-filter:blur(8px);background:rgba(255,255,255,.75);opacity:.85}:root body #app .bili-header .bili-header__bar.mini-header:hover,:root body #i_cecream .bili-feed4 .bili-header .bili-header__bar.mini-header:hover,html body #app .bili-header .bili-header__bar.mini-header:hover,html body #i_cecream .bili-feed4 .bili-header .bili-header__bar.mini-header:hover{backdrop-filter:blur(10px);opacity:1;background:rgba(255,255,255,.8)}:root body #app .bili-header .bili-header__bar.slide-down,:root body #i_cecream .bili-feed4 .bili-header .bili-header__bar.slide-down,html body #app .bili-header .bili-header__bar.slide-down,html body #i_cecream .bili-feed4 .bili-header .bili-header__bar.slide-down{box-shadow:0 1px 4px rgba(0,0,0,.05)!important;background:rgba(255,255,255,.75);backdrop-filter:blur(10px)}:root body #app .header-channel,:root body #i_cecream .bili-feed4 .header-channel,html body #app .header-channel,html body #i_cecream .bili-feed4 .header-channel{background:rgba(255,255,255,.55);backdrop-filter:blur(5px)}:root body #app .header-channel:has(.header-channel-fixed-down),:root body #i_cecream .bili-feed4 .header-channel:has(.header-channel-fixed-down),html body #app .header-channel:has(.header-channel-fixed-down),html body #i_cecream .bili-feed4 .header-channel:has(.header-channel-fixed-down){background:rgba(255,255,255,.7);backdrop-filter:blur(8px)}`,
	},
});
